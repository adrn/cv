...
\section*{Publications --- \href{\adsurl}{{\it ADS search} \faLink} \textrm{or} \href{https://adrian.pw/cv/PriceWhelan-pubs.pdf}{{\it Full publication list} \faLink}}
\vspace{-1em}

\input{summary}

\subsection*{Highlighted publications (selected first author, significant contributions, or direct mentor)}
    \begin{itemize}
        \input{pubs_selected}
    \end{itemize}
...
\begin{itemize}
    ...
    \item Mentor for 11 graduate students or post-baccalaureate students (resulting in 6 refereed publications; 4 publications in prep.)
    \item Mentor for 3 post-doctoral fellows (resulting in 2 refereed publications; 3 publications in prep.)
\end{itemize}
