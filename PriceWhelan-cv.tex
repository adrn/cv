...
\begin{itemize}
  \item
    \textbf{Research Scientist \& Leader of Galactic Dynamics Group} \\
  ...
  \item
    \href{mailto:aprice-whelan@flatironinstitute.org}{\faEnvelope ~~ aprice-whelan@flatironinstitute.org}
    ~~~
...
\section*{Education and past positions}
	\begin{itemize}
        \item 2021--2025, Associate Research Scientist, Flatiron Institute
...
{\color{deemph}\small \advisee{Underlined} first authors were/are students or postdocs I closely supervised.}
...
% \end{itemize}
    ...
    %     - Makaila Jennings (NSBP Scholar, 2026)
    ...
    %     - Richard Brooks (UCL, 2024)
    %     - Hiroka Warren (RPI, 2025)
    %     - Andrea Sante
    %     - Zoe Hackshaw
...
I mentor undergraduate, masters, and PhD students, along with postdoctoral fellows at the CCA and abroad. See my full publication list for recent publications with students and postdocs I have mentored.
\begin{itemize}
    \item Direct mentor for 10 undergraduate students or \textit{Google Summer of Code} participants (through the Astropy project),
    \item Mentor for over 20 masters, PhD, or post-baccalaureate students,
    \item Mentor for over 10 post-doctoral fellows.
\end{itemize}
...
\begin{itemize}
    \item \emph{Disorder in the Dynamic Milky Way}, CMU, 2025 (seminar)
...
\begin{itemize}
	...
	\item Core developer of
        ...
        \href{https://github.com/GalacticDynamics/galax}{galax},
        \href{https://github.com/GalacticDynamics/unxt}{unxt},
        \href{https://github.com/adrn/pollux}{pollux},
        \href{https://github.com/adrn/thejoker}{thejoker},
        \href{https://github.com/adrn/harv}{harv},
...
\begin{itemize}
    \item Organizer of the \emph{Planets in the Galactic Context} conference, 2026
    \item Organizer of the \emph{Tooling Up for Gaia DR4} workshop, 2026
    \item Organizer of the \emph{JAX in Astronomy} workshop, 2024
...
\begin{itemize}
    ...
    \item TACs: NASA, NOAO, Roman
    \item NSF Committee of Visitors (2023)
    \item Member of the Roman Science User Panel
\end{itemize}
